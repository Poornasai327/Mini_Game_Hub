    ...
    def play(self):
        ...
        if self.still_playing:      # Displaying preview effect if still playing
            ...
            if self.current_player == 0:
                Text = self.celinda_font.render("O's Turn",1,(255,255,255))
            else:
                Text = self.celinda_font.render("X's Turn",1,(255,255,255))
            ...
            if self.check_win():
                if self.current_player == 0:
                    winner_text = self.celinda_font.render("O Won",1,(255,255,255))
                else:
                    winner_text = self.celinda_font.render("X Won",1,(255,255,255))
